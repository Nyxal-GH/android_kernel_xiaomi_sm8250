...
if ! command -v ccache >/dev/null 2>&1; then
    echo "[ccache] does not exist, please check your environment."
    exit 1
fi
...
MAKE_ARGS=(
    ...
    "HOSTCXX=$CCACHE_BIN g++"
    CROSS_COMPILE=aarch64-suse-linux-
    CROSS_COMPILE_ARM32=arm-suse-linux-gnueabi-
    CROSS_COMPILE_COMPAT=arm-suse-linux-gnueabi-
    CLANG_TRIPLE=aarch64-suse-linux-
)
